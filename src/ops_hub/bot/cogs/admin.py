    ...
    def _build_command_access(self) -> str:
        ...
        return "\n".join(
            [
                ...
                "`/tech_assignments`, `/tech_job`, `/dispatch_board`, `/dispatch_attention`, `/attention_ack`, `/attention_snooze`, `/attention_assign`, `/dispatch_next`, `/photo_compliance_board`: dispatchers, admins",
