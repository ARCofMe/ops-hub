...
def test_build_command_access_describes_current_scopes() -> None:
    ...
    assert "`/tech_assignments`, `/tech_job`, `/dispatch_board`, `/dispatch_attention`, `/triage_disposition`, `/attention_ack`, `/attention_snooze`, `/attention_assign`, `/attention_clear_owner`, `/attention_unsnooze`, `/attention_reopen`, `/attention_history`, `/dispatch_next`, `/photo_compliance_board`: dispatchers, admins" in result
